        ...
        if message:
            ...
            if len(parts) == 3:
                ...
                with lock:
                    ...
                    elif msg.strip().lower() == "connect":
                        peer_list.add((ip, port))
...
while True:
    ...
    if choice == "1":
        ...
        connect_to_peer()
        print("Sent 'connect' to all active peers.")
    elif choice == "0":

        with lock:
            for ip, port in peer_list.copy():
